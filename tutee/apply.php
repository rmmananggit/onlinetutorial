...
<div class="container">
    <ol class="breadcrumb mb-2">
        ...
        <li class="breadcrumb-item active">Online Tutoring Services Details</li>
    </ol>
    ...
    <div class="row">
        ...
        ?>
                <div class="col-md-5">
                    <div class="project-info-box" style="max-height: 200px; word-wrap: break-word;">
                        <h5>Description:</h5>
                        <p class="mb-0"><?= $user['description']; ?></p>
                    </div>

                    <div class="project-info-box">
                        <p><b>Status: </b><span style="color: green;"><?= $user['Status']; ?></span></p>
                        <p><b>Date Posted: </b><?php $datePosted = strtotime($user['date_posted']);
                                                $formattedDate = date('Y-m-d', $datePosted);
                                                echo $formattedDate; ?></p>
                        <p><b>Tutor Name:</b> <?= $user['firstname']; ?> <?= $user['middlename']; ?> <?= $user['lastname']; ?></p>
                        <p><b>Mobile Number:</b> <?= $user['contact_no']; ?></p>
                        <p class="mb-0"><b>Price:</b> ₱<?= $user['rate']; ?>/<?= $user['rate_desc']; ?></p>
